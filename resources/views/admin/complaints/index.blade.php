            ...
            <form method="GET" action="{{ route('admin.complaints.index') }}" class="row g-3">
                ...
                <div class="col-md-2">
                    <select name="type" class="form-select" onchange="this.form.submit()">
                        <option value="all" {{ request('type', 'all') === 'all' ? 'selected' : '' }}>Semua Jenis
                        </option>
                ...
                <div class="col-md-2">
                    <select name="priority" class="form-select" onchange="this.form.submit()">
                        <option value="all" {{ request('priority', 'all') === 'all' ? 'selected' : '' }}>Semua Prioritas
                        </option>
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control" placeholder="Cari subjek, pesan, user..."
