        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <span
                            class="badge bg-{{ $complaint->type === 'complaint' ? 'warning' : ($complaint->type === 'report' ? 'danger' : 'info') }} me-2">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start mb-3">
                        <div class="user-avatar-sm me-3"
                            style="width: 44px; height: 44px; border-radius: 10px; background: linear-gradient(135deg, #6366f1, #8b5cf6); display: flex; align-items: center; justify-content: center; font-weight: 700; color: white; flex-shrink: 0;">
            ...
            @if ($complaint->admin_response)
                <div class="card mb-4 border-success">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start mb-3">
                            <div class="user-avatar-sm me-3"
                                style="width: 44px; height: 44px; border-radius: 10px; background: linear-gradient(135deg, #22c55e, #16a34a); display: flex; align-items: center; justify-content: center; font-weight: 700; color: white; flex-shrink: 0;">
                        ...
                        <div class="p-3 rounded"
                            ...
                            <p class="text-secondary mb-0" style="white-space: pre-wrap;">{{ $complaint->admin_response }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.complaints.update', $complaint) }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="status" class="form-select @error('status') is-invalid @enderror">
                                    ...
                                    <option value="in_progress"
                                        {{ $complaint->status === 'in_progress' ? 'selected' : '' }}>Diproses</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="priority" class="form-select @error('priority') is-invalid @enderror">
                                    <option value="low" {{ $complaint->priority === 'low' ? 'selected' : '' }}>Rendah
                                    </option>
                                    <option value="normal" {{ $complaint->priority === 'normal' ? 'selected' : '' }}>Normal
                                    </option>
                                    <option value="high" {{ $complaint->priority === 'high' ? 'selected' : '' }}>Tinggi
                                    </option>
                                    <option value="urgent" {{ $complaint->priority === 'urgent' ? 'selected' : '' }}>
                                        Mendesak</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="admin_response" class="form-control @error('admin_response') is-invalid @enderror" rows="5"
                                placeholder="Berikan tanggapan untuk pengguna..." required>{{ old('admin_response', $complaint->admin_response) }}</textarea>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span
                            class="badge bg-{{ $complaint->status === 'pending' ? 'warning' : ($complaint->status === 'resolved' ? 'success' : 'info') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <span
                            class="badge bg-{{ $complaint->priority === 'urgent' ? 'danger' : ($complaint->priority === 'high' ? 'warning' : 'secondary') }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        <div class="user-avatar-sm me-3"
                            style="width: 48px; height: 48px; border-radius: 12px; background: linear-gradient(135deg, #6366f1, #8b5cf6); display: flex; align-items: center; justify-content: center; font-weight: 700; color: white; font-size: 1rem;">
                            {{ substr($complaint->user->name, 0, 2) }}
                        </div>
                        <div>
                            <h6 class="text-white mb-0">{{ $complaint->user->name }}</h6>
