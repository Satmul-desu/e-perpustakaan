                    ...
                    <div class="card-body">
                        ...
                        <div class="card mb-4" style="background: rgba(30, 41, 59, 0.95); border: 1px solid #334155;">
                            <div class="card-header"
                                style="background: rgba(15, 23, 42, 0.5); border-bottom: 1px solid #334155;">
                                ...
                                <div class="card mb-4"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center mb-3">
                                            <span class="badge bg-{{ $statusColors[$loan->status] ?? 'secondary' }} p-3"
                                        ...
                                        @if ($loan->status == 'pending')
                                            <div class="alert alert-info mb-3">
                                                ...
                                                Peminjaman akan langsung berstatus <strong>Dipinjam</strong> dengan durasi
                                                <strong>45 jam</strong> setelah disetujui.
                                            </div>
                                                ...
                                                <div class="modal-body" style="border-color: #334155;">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="days" class="form-select"
                                                            style="background: rgba(15, 23, 42, 0.6); border: 1px solid #334155; color: white;">
