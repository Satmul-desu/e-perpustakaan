...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{ route('admin.reports.export-loans.excel', request()->query()) }}" class="btn btn-success">
                <i class="bi bi-file-earmark-excel me-2"></i>Google Excel
            </a>
            <a href="{{ route('admin.reports.export-loans.word', request()->query()) }}" class="btn btn-primary">
                <i class="bi bi-file-earmark-word me-2"></i>Google Word
            </a>
        </div>
    </div>
