        ...
        <div class="col-md-3">
            <div class="stat-card">
                ...
                <div class="stat-change">
                    <span>Periode: {{ \Carbon\Carbon::parse($dateFrom)->format('d M') }} -
                        {{ \Carbon\Carbon::parse($dateTo)->format('d M Y') }}</span>
                </div>
            </div>
        </div>
        <div class="col-md-3">
                                ...
                                @forelse($byCategory as $category)
                                    <tr>
                                        ...
                                        <td class="text-center fw-medium">Rp
                                            {{ number_format($category->total_revenue, 0, ',', '.') }}</td>
                                        <td class="text-end">
                                ...
                                @forelse($topProductsByCategory->flatten()->take(10) as $product)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <span
                                                class="badge bg-success">{{ number_format($product->total_sold) }}</span>
                                        </td>
                    ...
                    <tbody>
                        @forelse($orders as $order)
                            <tr>
                                ...
                                <td class="fw-bold text-success">Rp {{ number_format($order->total_amount, 0, ',', '.') }}
                                </td>
                                <td>
