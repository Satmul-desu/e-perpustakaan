                    ...
                    <div class="row g-4">
                        <div class="col-lg-7">
                            <div class="card card-custom">
                                <div class="card-header border-secondary rounded-top-4"
                                    ...
                                    <form action="{{ route('checkout.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name"
                                                class="form-control form-control-lg dark-form-control"
                        ...
                        <div class="col-lg-5">
                            <div class="card card-custom shadow-lg sticky-summary">
                                ...
                                <div class="card-body p-4" style="color: #f1f5f9;">
                                    @foreach ($cart->items as $item)
                                        <div class="d-flex justify-content-between mb-3">
                                            <div>
                                                ...
                                                <small class="text-secondary">{{ $item->quantity }} x
                                                    {{ $item->product->formatted_price }}</small>
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between p-3 rounded mt-3"
