...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .form-container, .history-container, .contact-card {
            padding: 1.25rem;
            border-radius: 16px;
        }
    }
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <p class="hero-subtitle">
                        Kami siap membantu Anda! Sampaikan keluhan, laporan, atau pertanyaan Anda melalui form di bawah. Tim kami akan merespons dalam waktu 1x24 jam.
                    </p>
                </div>
                    ...
                    <a href="{{ route('cs.show', $complaint) }}" class="complaint-item d-block">
                        <div class="d-flex justify-content-between align-items-start mb-2">
                            <div class="d-flex gap-1 flex-wrap">
                                ...
                                <span class="badge bg-{{ $complaint->priority === 'urgent' ? 'danger' : 'secondary' }} complaint-badge">
                                    {{ $complaint->priority_name }}
                                </span>
                            </div>
                            <small class="text-muted">{{ $complaint->created_at->diffForHumans() }}</small>
                        </div>
                        <h6 class="text-white mb-1" style="font-size: 0.95rem; font-weight: 600;">{{ $complaint->subject }}</h6>
