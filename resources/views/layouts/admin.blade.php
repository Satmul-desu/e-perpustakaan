            ...
            <header class="top-header d-flex justify-content-between align-items-center">
                ...
                <div class="header-actions">
                    ...
                    <div class="dropdown-container">
                        <button class="btn-icon dropdown-toggle-custom" id="notificationDropdown" title="Notifikasi"
                            onclick="toggleDropdown('notificationDropdown', 'notificationMenu')">
                            <i class="bi bi-bell"></i>
                            @if ((isset($complaintCount) && $complaintCount > 0) || (isset($pendingCount) && $pendingCount > 0))
                                <span
                                    class="badge notification-badge-pulse">{{ ($complaintCount ?? 0) + ($pendingCount ?? 0) }}</span>
                            @endif
                        </button>
                        <div class="dropdown-menu-custom" id="notificationMenu">
                            <div class="dropdown-header-custom">
                                ...
                                @if (($complaintCount ?? 0) > 0 || ($pendingCount ?? 0) > 0)
                                    <span
                                        class="badge bg-warning text-dark">{{ ($complaintCount ?? 0) + ($pendingCount ?? 0) }}
                                        baru</span>
                                @endif
                            </div>
                                    ...
                                    @foreach ($recentComplaints as $complaint)
                                        <a href="{{ route('admin.complaints.show', $complaint) }}" class="dropdown-item-custom">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="description">{{ Str::limit($complaint->message, 50) }}
                                                </div>
                                            </div>
                    ...
                    <div class="dropdown-container">
                        <button class="btn-icon dropdown-toggle-custom" id="settingsDropdown" title="Pengaturan"
                            onclick="toggleDropdown('settingsDropdown', 'settingsMenu')">
