                                    ...
                                    <tr style="border-color: #334155; background: rgba(30, 41, 59, 0.7);">
                                        ...
                                        <td class="py-3">
                                            @php
                                                $statusBgColors = [
                                                    'pending' =>
                                                        'background: rgba(245, 158, 11, 0.2); border: 1px solid #f59e0b; color: #fbbf24 !important;',
                                                    'approved' =>
                                                        'background: rgba(59, 130, 246, 0.2); border: 1px solid #3b82f6; color: #60a5fa !important;',
                                                    'borrowed' =>
                                                        'background: rgba(99, 102, 241, 0.2); border: 1px solid #6366f1; color: #818cf8 !important;',
                                                    'returned' =>
                                                        'background: rgba(16, 185, 129, 0.2); border: 1px solid #10b981; color: #34d399 !important;',
                                                    'overdue' =>
                                                        'background: rgba(239, 68, 68, 0.2); border: 1px solid #ef4444; color: #f87171 !important;',
                                                    'cancelled' =>
                                                        'background: rgba(107, 114, 128, 0.2); border: 1px solid #6b7280; color: #9ca3af !important;',
                                                ];
                                                $statusText = [
                                                    'pending' => 'Menunggu',
                                                    'approved' => 'Disetujui',
