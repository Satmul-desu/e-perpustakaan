                    ...
                    <div class="timeline">
                        <div class="timeline-item mb-4">
                            <div class="d-flex align-items-start">
                                <div class="me-3">
                                    <span class="badge d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #6366f1, #4f46e5);">
                        ...
                        <div class="timeline-item mb-4">
                            <div class="d-flex align-items-start">
                                <div class="me-3">
                                    <span class="badge d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #3b82f6, #2563eb);">
                                        <i class="bi bi-check-lg"></i>
                                    </span>
                                </div>
                                <div>
                                    <p class="text-white mb-1 fw-bold">Peminjaman Disetujui</p>
                                    <small class="text-secondary">{{ $loan->updated_at->format('d M Y, H:i') }}</small>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="timeline-item mb-4">
                            <div class="d-flex align-items-start">
                                <div class="me-3">
                                    <span class="badge d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #8b5cf6, #7c3aed);">
                                        <i class="bi bi-box-arrow-right"></i>
                                    </span>
                                </div>
                                <div>
                                    <p class="text-white mb-1 fw-bold">Buku Diambil</p>
                                    <small class="text-secondary">{{ $loan->loan_date->format('d M Y, H:i') }}</small>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="timeline-item">
                            <div class="d-flex align-items-start">
                                <div class="me-3">
                                    <span class="badge d-flex align-items-center justify-content-center" style="width: 40px; height: 40px; border-radius: 10px; background: linear-gradient(135deg, #22c55e, #16a34a);">
                                        <i class="bi bi-check-circle"></i>
                                    </span>
                                </div>
                                <div>
                                    <p class="text-white mb-1 fw-bold">Buku Dikembalikan</p>
                                    <small class="text-secondary">{{ $loan->return_date->format('d M Y, H:i') }}</small>
                                </div>
                            </div>
                        </div>
                        @endif
            ...
            <div class="card mb-4" style="background: rgba(30, 41, 59, 0.95); border: 1px solid #334155; border-radius: 16px;">
                ...
                <div class="card-body">
                    @php
                        ...
                        $statusBgColors = [
                            'pending' => 'background: linear-gradient(135deg, rgba(245, 158, 11, 0.2), rgba(234, 88, 12, 0.2)); border: 1px solid #f59e0b; color: #fbbf24 !important;',
                            'approved' => 'background: linear-gradient(135deg, rgba(59, 130, 246, 0.2), rgba(37, 99, 235, 0.2)); border: 1px solid #3b82f6; color: #60a5fa !important;',
                            'borrowed' => 'background: linear-gradient(135deg, rgba(99, 102, 241, 0.2), rgba(79, 70, 229, 0.2)); border: 1px solid #6366f1; color: #818cf8 !important;',
                            'returned' => 'background: linear-gradient(135deg, rgba(34, 197, 94, 0.2), rgba(22, 163, 74, 0.2)); border: 1px solid #22c55e; color: #34d399 !important;',
                            'overdue' => 'background: linear-gradient(135deg, rgba(239, 68, 68, 0.2), rgba(220, 38, 38, 0.2)); border: 1px solid #ef4444; color: #f87171 !important;',
                            'cancelled' => 'background: linear-gradient(135deg, rgba(107, 114, 128, 0.2), rgba(75, 85, 99, 0.2)); border: 1px solid #6b7280; color: #9ca3af !important;'
                        ];
                        $statusText = [
