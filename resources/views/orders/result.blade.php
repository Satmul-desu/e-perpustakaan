                    ...
                    <div class="card card-custom">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                <h4 class="fw-bold text-white mb-3">Order #{{ $order->order_number }}</h4>
                                <div
                                    class="alert alert-danger bg-danger bg-opacity-10 border-danger text-danger d-inline-block px-4 py-2 rounded-pill mb-4">
                                ...
                                <div class="text-start bg-dark bg-opacity-25 rounded-3 p-3 mb-4">
                                    <div class="d-flex justify-content-between mb-2">
                                        ...
                                        <span class="fw-bold text-white small">Rp
                                            {{ number_format($order->items_subtotal, 0, ',', '.') }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="card card-custom">
                        <div class="card-body p-4">
                            <div class="text-center mb-4">
                                <h4 class="fw-bold text-white mb-3">Order #{{ $order->order_number }}</h4>
                                <div
                                    class="alert alert-warning bg-warning bg-opacity-10 border-warning text-warning d-inline-block px-4 py-2 rounded-pill mb-4">
                            ...
                            window.snap.pay('{{ $order->snap_token }}', {
                                onSuccess: function(result) {
                                    ...
                                    window.location.href =
                                        '{{ route('orders.result', ['order' => $order, 'status' => 'success']) }}';
                                },
                                onPending: function(result) {
                                    console.log('Payment Pending:', result);
                                    window.location.href =
                                        '{{ route('orders.result', ['order' => $order, 'status' => 'pending']) }}';
                                },
                                onError: function(result) {
                                    console.log('Payment Error:', result);
                                    window.location.href =
                                        '{{ route('orders.result', ['order' => $order, 'status' => 'failed']) }}';
                                },
                                onClose: function() {
                                    payButton.disabled = false;
                                    payButton.innerHTML =
