                                    ...
                                    <div class="d-flex justify-content-between align-items-center p-4 border-bottom">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-secondary">{{ $item->quantity }} x Rp
                                                    {{ number_format($item->price, 0, ',', '.') }}</small>
                                            </div>
                                        </div>
                                        <span class="fw-bold text-custom">Rp
                            ...
                            <div class="card card-custom">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-secondary small mb-4">
                                        Total: <strong class="text-custom">Rp
                                            {{ number_format($order->total_amount, 0, ',', '.') }}</strong>
                                    </p>
                                    <button id="pay-button" class="btn btn-custom btn-lg w-100 fw-bold mb-3"
                                    ...
                                    <p class="text-secondary small mb-0 snap-unavailable" style="display: none;">
                                        ...
                                        Snap.js terblokir?
                                        <a href="#"
                                            onclick="alert('Silakan cek email invoice untuk link pembayaran atau hubungi admin.'); return false;">
                                ...
                                snap.pay(data.token, {
                                    onSuccess: function(result) {
                                        ...
                                        window.location.href =
                                            `/orders/{{ $order->id }}/result/success`;
                                    },
                                    onPending: function(result) {
                                        console.log('Payment Pending:', result);
                                        window.location.href =
                                            `/orders/{{ $order->id }}/result/pending`;
                                    },
                                    onError: function(result) {
                                        console.log('Payment Error:', result);
                                        window.location.href =
                                            `/orders/{{ $order->id }}/result/failed`;
                                    },
                                    onClose: function() {
                                        payButton.disabled = false;
                                        payButton.innerHTML =
