<footer class="modern-footer mt-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 footer-brand">
                ...
                <p class="footer-desc text-secondary small mb-3">
                    Perpustakaan Buku Online Terpercaya, Murah, Aman, dan Lengkap dengan berbagai genre buku
                    berkualitas.
                </p>
        ...
        <div class="footer-bottom mt-4 pt-3 border-secondary">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-3 mb-md-0">
                    <span class="text-secondary me-3 small">Metode Pembayaran:(jika ingin di tebus atau terkena
                        denda)</span>
    ...
    <button class="back-to-top btn btn-primary rounded-circle" onclick="window.scrollTo({top: 0, behavior: 'smooth'})"
