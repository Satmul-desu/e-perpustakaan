@php
    ...
    $imageUrl =
        $product->primaryImage?->image_url ?? ($product->image_url ?? asset('images/image-removebg-preview.png'));
        ...
        <div class="product-image-wrapper position-relative overflow-hidden">
            ...
            @auth
                <button onclick="toggleWishlist({{ $product->id }})"
                    ...
                    style="z-index: 10;">
                    <i
                        class="bi {{ Auth::check() && Auth::user()->hasInWishlist($product) ? 'bi-heart-fill text-danger' : 'bi-heart' }}"></i>
                </button>
            @endauth
            @if ($product->stock == 0)
                <div
                    class="overlay-badge position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center">
