            ...
            <div class="row g-4">
                ...
                @if ($user->isAdmin())
                    <div class="col-12">
                        <div class="profile-card border-primary">
                            ...
                            <div class="card-body">
                                <p class="text-secondary mb-3">Anda memiliki akses administrator. Klik tombol di bawah untuk
                                    masuk ke panel admin.</p>
                ...
                <div class="col-lg-6">
                    <div class="profile-card border-danger">
                        ...
                        <div class="card-body">
                            <p class="text-secondary mb-3">Tindakan ini tidak dapat dibatalkan. Semua data Anda akan dihapus
                                permanen.</p>
